    ...
    <div className="max-w-[1200px] mx-auto pb-24 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 bg-white p-8 rounded-3xl shadow-sm border border-slate-100">
        <div>
          ...
          <p className="text-slate-500 font-medium">Manage the Influencer hero banner and vertical video cards.</p>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-slate-500 font-medium mt-1">Manage the video reels and captions.</p>
            </div>
            <button
              onClick={addCard}
            ...
            {data.influencerCards.map((card, index) => (
              ...
              >
                ...
                <div className="space-y-6">
                  ...
                  <Field label="Video Thumbnail (Poster)">
                    <div className="space-y-4">
                  ...
                  <Field label="Influencer Name">
                    <input
                      type="text"
                      value={card.influencerName}
                      onChange={(e) => updateCard(index, 'influencerName', e.target.value)}
                      className={inputCls}
                    />
                  </Field>

                  <Field label="Caption / Short Title">
                    <textarea
                      value={card.caption}
                  ...
                  <Field label="Instagram / Reel Link">
                    <input
                      type="text"
                      value={card.instagramLink}
                      onChange={(e) => updateCard(index, 'instagramLink', e.target.value)}
                      className={inputCls}
                    />
                  </Field>
