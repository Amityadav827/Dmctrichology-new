...
const ShowcaseStyles = () => (
  <style>{`
    ...
    .pm-card:hover .pm-card-img { transform: scale(1.06); }
    ...
    .pm-card:hover .pm-card-img-overlay { opacity: 0.8; }
    ...
    .pm-card:hover .pm-card-logo-wrap { transform: translateY(-3px); }
    ...
    .pm-card:hover .pm-card-link-icon { opacity: 1; transform: scale(1); }
    ...
    .pm-card-cta:hover { color: #1a2d6b; border-color: #1a2d6b; gap: 10px; }
    ...
    @media (max-width: 1024px) {
      .pm-cards-grid { grid-template-columns: repeat(2, 1fr); gap: 22px; }
      .pm-showcase-title { font-size: 36px !important; }
    }

    @media (max-width: 640px) {
      .pm-showcase-section { padding: 60px 5% 70px; }
      .pm-cards-grid { grid-template-columns: 1fr; gap: 18px; }
      .pm-showcase-title { font-size: 28px !important; }
      .pm-showcase-header { margin-bottom: 40px; }
    }
  `}</style>
);
