...
const defaultGrades = [
  { id: 1, grade: 'GRADE 1', displayNum: '1', area: '20 cmÂ²', density: '40/cmÂ²', grafts: '800', session: '1', image: 'https://fxzkbhhinbjbeegkjnae.supabase.co/storage/v1/object/public/images/gallery/1777962139479-s4afgaemlnxgpza6klc2.png' },
  { id: 2, grade: 'GRADE 2', displayNum: '2', area: '40 cmÂ²', density: '40/cmÂ²', grafts: '1600', session: '1', image: 'https://fxzkbhhinbjbeegkjnae.supabase.co/storage/v1/object/public/images/gallery/cloudinary-recovery/txprqtwbqrckrqbbtkbm.png' },
  { id: 3, grade: 'GRADE 3', displayNum: '3', area: '60 cmÂ²', density: '40/cmÂ²', grafts: '2400', session: '1', image: 'https://fxzkbhhinbjbeegkjnae.supabase.co/storage/v1/object/public/images/gallery/1777962138168-lm1wuhdnisarojusnl1c.png' },
  { id: 4, grade: 'GRADE 4', displayNum: '4', area: '80 cmÂ²', density: '40/cmÂ²', grafts: '3200', session: '1-2', image: 'https://fxzkbhhinbjbeegkjnae.supabase.co/storage/v1/object/public/images/gallery/1777962137445-fnby98gc9fgctznkbpdt.png' },
  { id: 5, grade: 'GRADE 5', displayNum: '5', area: '100 cmÂ²', density: '40/cmÂ²', grafts: '4000', session: '2', image: 'https://fxzkbhhinbjbeegkjnae.supabase.co/storage/v1/object/public/images/gallery/cloudinary-recovery/r3etpyboaedgq8gizzpc.png' }
];
        ...
        <div className="slider-container" style={{ position: 'relative', maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginTop: '40px' }}>
            <button className="grade-prev-btn" style={{
              ...
              <img
                src="https://fxzkbhhinbjbeegkjnae.supabase.co/storage/v1/object/public/images/gallery/cloudinary-recovery/apdtgxwhhkwjz2c6l7lv.png"
                alt="Prev"
