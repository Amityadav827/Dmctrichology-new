...
const staticFallback = {
  ...
  formSettings: {
    ...
    successMessage: "Your consultation request has been successfully submitted to Dr. Nandini Dadu's private desk. Our concierge team will reach out to you shortly."
  },

  seo: {
    metaTitle: "Dr. Nandini Dadu | Best Hair Restoration Specialist & Trichologist",
    metaDescription: "Consult Delhi's premier hair restoration specialist, Dr. Nandini Dadu. Experience luxury clinical consultations, high-density transplants, and customized scalp treatments.",
    ogImage: ""
  },
  breadcrumb: {
  ...
  testimonialsSection: {
    ...
    testimonials: [
      ...
      {
        text: "Dr. Nandini Dadu is the best hair transplant surgeon in Delhi. I underwent a hair transplant procedure at her clinic, and the results have been amazing. She uses advanced techniques and ensures a comfortable procedure.",
      ...
      {
        text: "Dr. Nandini Dadu is undoubtedly the best hair specialist in Delhi. She helped me regain confidence with her effective treatment for hair thinning. Her approach is personalized, focusing on understanding the root cause of hair problems.",
...
async function getPageData() {
  try {
    ...
    console.error('SSR Fetch Error (Dr. Nandini page):', error);
...
async function getHomeFaqData() {
  try {
    ...
    console.error('SSR Fetch Error (Home FAQ for Dr. Nandini page):', error);
    return null;
  }
}
