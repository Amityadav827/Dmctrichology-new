      ...
      <div className="max-w-2xl mx-auto text-center">
        <h1 
          ...
          style={{ 
            ...
            background: 'linear-gradient(135deg, #ffffff 0%, #3B5998 100%)',
        ...
        <Link 
          href="/service"
          className="inline-flex items-center justify-center px-10 py-4 bg-[#3B5998] text-white rounded-full font-semibold transition-all hover:bg-[#ffffff] hover:scale-105"
          style={{ fontFamily: "'Marcellus', serif" }}
        >
