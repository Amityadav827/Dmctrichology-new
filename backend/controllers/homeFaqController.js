...
exports.updateHomeFAQ = async (req, res) => {
  try {
    ...
    if (u.categories !== undefined) merged.categories = u.categories;
    if (u.buttonText !== undefined) merged.buttonText = u.buttonText;
    if (u.buttonLink !== undefined) merged.buttonLink = u.buttonLink;
